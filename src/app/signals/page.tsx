    ...
    <AppShell>
      <div className="px-5 py-5 sm:px-8">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          ...
          <span className="w-fit rounded-md bg-[#1f0a0a] px-2 py-1 text-xs text-[#ef4444]">
                ...
                <article className="space-y-3 p-4" key={signal.id}>
                  <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-[#d4d4d4]">{signal.summary}</p>
                      {signal.source_url ? (
                        <a
                          className="mt-2 inline-block text-sm text-[#ef4444] underline-offset-4 hover:underline"
